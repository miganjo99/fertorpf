...
export default function WhatsAppButton() {
  ...
  const phoneNumber = '34634426437'; 

  const message = '👋 Hola, sé que las plazas son limitadas, pero estoy totalmente comprometido a mejorar mi rendimiento. Quiero más información sobre tu programa FertorPF porque estoy listo para empezar y llevar mi nivel de juego al máximo. ¡Vamos con todo!🚀';
